    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-white mt-2">Duplicate Request Prevention</h1>
      ...
      {/* Table container */}
      <div className="flex-1 border border-surface/50 rounded-lg overflow-hidden flex flex-col bg-background/80 backdrop-blur">
